    ...
    <header className="w-full">
      ...
      <div className="bg-white shadow-sm py-4 px-6 flex items-center justify-between">
        ...
        <div className="flex space-x-4">
          <button className="bg-teal-600 text-white px-4 py-2 rounded-full">Sign in</button>
          <button className="bg-white border border-gray-300 text-black px-4 py-2 rounded-full">Sign up</button>
        </div>
      </div>
